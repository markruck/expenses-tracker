  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        <input type="date" id="date" name="date" required={true} onChange={(e) => { setDate(new Date(e.target.value)) }} />
        <label htmlFor="income">Amount</label>
        <input type="number" id="amount" name="amount" required={true} onChange={(e) => { setAmount(e.target.valueAsNumber) }} />
